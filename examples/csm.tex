...
\usepackage[
  ...
  container-fill=nskSecondaryAccent!60!nskBg,
  container-border-color=nskBlue,
  fillbetween-fill=nskStrongBlue!50!nskFg,
  fillbetween-border-color=nskStrongBlue!80!nskFg,
  dark-mode=true,
]{neural-sketch}
\nskUseModule{*}
...
\begin{nskFigure}[]
	...
	\nskFillBetween[from=a, to=\nskBlockIDLast{1}, edge=curved, corner-offset=4mm]
	\nskBlock[
	...
	\nskFillBetween[from=aa, to=\nskBlockIDLast{1}, edge=curved, corner-offset=5mm]
	...
	% edgefade block ~~~~~~~~~~~~~~~~~~~~~~~~~~~~ <<<
  \nskEdgeFade[edge=left, size=20mm]
  \nskEdgeFade[edge=right, size=20mm]
\end{nskFigure}
\end{document}
