...
\NewDocumentCommand{\batch}{t!t*m}{
  ...
  \IfBooleanTF{#2}{\def\fc{nskLightGray}}{\def\fc{nskRed}}
  \IfBooleanTF{#2}{\nskContainer[padding=1.5mm, border-radius=4mm, fill=nskLightGray]}
  {\nskContainer[padding=1.5mm, border-radius=4mm]}{
		\foreach \c in {31,...,29} {
        \IfBooleanTF{#1}{
