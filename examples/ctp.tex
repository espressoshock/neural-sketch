...
\def\cyan{fill=nskStrongCyan!20!nskBg, border-color=nskStrongCyan}

\def\grapeC{color=nskStrongGrape}
\def\grape{fill=nskStrongGrape!20!nskBg, border-color=nskStrongGrape}

\def\cyanL{fill=nskSecondaryAccent!40!nskBg, border-color=nskBlue}
\def\grapeL{fill=nskStrongGrape!12!nskBg, border-color=nskStrongGrape}
\def\mc{fill=nskMainAccent!40!nskBg, border-color=nskMainAccent}
